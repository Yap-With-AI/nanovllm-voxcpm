"""Utility functions for VoxCPM model.

Provides tokenizer wrapping and dtype conversion utilities.
"""
...
def get_dtype(dtype: str) -> torch.dtype:
    ...
    Args:
        dtype: String representation of dtype (e.g., "bfloat16", "float16", "float32")
