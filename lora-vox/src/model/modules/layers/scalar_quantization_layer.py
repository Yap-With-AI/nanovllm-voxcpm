"""Scalar quantization layer for VoxCPM.

Provides differentiable scalar quantization for latent representations.
"""
...
class ScalarQuantizationLayer(nn.Module):
    """Scalar quantization layer with straight-through gradient estimator."""
