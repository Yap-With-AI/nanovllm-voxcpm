"""Local DiT (Diffusion Transformer) for VoxCPM.

Implements the diffusion transformer estimator for audio generation.
"""
...
class VoxCPMLocDiT(nn.Module):
    """Diffusion model with a Transformer backbone for VoxCPM."""
